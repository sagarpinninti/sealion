...
function addSections(generateParameters, appSchema, pages) {
    ...
    if (generateParameters.entitySet?.entityType) {
        headerSections[ux_specification_types_1.SchemaTag.annotationPath] = `/${generateParameters.entitySet.entityType.fullyQualifiedName}/@${"com.sap.vocabularies.UI.v1.HeaderFacets" /* UIAnnotationTerms.HeaderFacets */}`;
    }
    if (!pages) {
        return;
    }
